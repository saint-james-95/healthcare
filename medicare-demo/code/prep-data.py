...
DATASET = pd.read_csv('ref_data/Medicare_Provider_Util_Payment_PUF_2012.txt', sep='\t', header=0, skiprows=[1], dtype=str, usecols=['NPI', 'PROVIDER_TYPE', 'HCPCS_CODE', 'HCPCS_DESCRIPTION', 'BENE_DAY_SRVC_CNT'])
